...
(() => {
  ...
  const SFX = {
    ...
    door: () => beep(280, 0.12, 'square', 0.05, 0, 420),                       // el shoop de toda la vida
    doors: () => { beep(784, 0.14, 'sine', 0.06); beep(659, 0.18, 'sine', 0.05, 0.16); }, // campanita del vagón
    brake: () => { beep(1100, 0.5, 'sawtooth', 0.035, 0, -650); noise(0.4, 0.03, 0.1); },
    save: () => [659, 880, 1046, 1318].forEach((f, i) => beep(f, 0.08, 'square', 0.045, i * 0.07)),
  ...
  const TRACKS = {
    ...
    calle: { bpm: 124, seq: [ // arriba, en la calle: sol de esquina
